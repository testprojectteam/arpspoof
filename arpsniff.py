...
def arp_frame(data):
 ...
 return arpTargetHardAddress,arpSenderHardAddress,arpTargetProtAddress
...
def main():
 ...
 while True:
  ...
  arpdest_mac, arpsrc_mac, dest_ip = arp_frame(raw_data)[0], arp_frame(raw_data)[1], arp_frame(raw_data)[2]
